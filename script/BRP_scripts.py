...
k       = 100
n_it    = 3
brpt.m_brp(mrange, n, k, n_it, corr=False, abs_val=False)
...
k       = 100
n_it    = 3
brpt.n_brp(m, nrange, k, n_it, corr=False, abs_val=False)
...
n_it    = 3
brpt.k_brp(m, n, krange, n_it, corr=False, abs_val=False)
